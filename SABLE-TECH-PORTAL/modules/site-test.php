...
$testCats = $comm->Post('GetData', $wsi->Get('testcats'), 'array');
...
<div id="site-test" class="module"> <!-- Add 'testing' class to site-test module to show alternate heading -->
    <div class="module-header start_collapsed">
        ...
        <div id="test-heading" class="module-name">
            ...
            <div>Site - On Test Until <span id="test-end-date"></span></div>
        </div>
        ...
        <div id="test-category" class="test-input">
            ...
            <select>
                <?php
                    ...
                    {
                        echo '<option value="'.trim($testcat->testcat_id).'" data-default_hours="'.
                            trim($testcat->default_hours).'">'.trim($testcat->descr).'</option>';
                    }
                ?>
    		</select>
        </div>
