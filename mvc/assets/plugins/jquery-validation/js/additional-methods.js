...
jQuery.validator.addMethod('phone', function(value) { return (value.match(/^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/)); }, 'Please enter a valid phone number');
...
//cvv code
jQuery.validator.addMethod("CVVCODE", function(val, elem) 
{
    // will contain our validation code
    var urlregex = new RegExp("^[0-9]{3,4}$");
