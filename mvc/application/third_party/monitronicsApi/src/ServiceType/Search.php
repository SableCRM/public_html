...
class Search extends AbstractSoapClientBase
{
     ...
     * @param \StructType\SearchContracts $parameters
     * @return \StructType\SearchContractsResponse|bool
     */
    public function SearchContracts(\StructType\SearchContracts $parameters)
    {
        try {
