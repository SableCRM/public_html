...
/**
 * This class stands for GetContractAsPrimary StructType
 * @subpackage Structs
 */
class GetContractAsPrimary extends AbstractStructBase
{
    /**
     * The EnvelopeID
    ...
    public $EnvelopeID;
    /**
     * Constructor method for GetContractAsPrimary
     * @uses GetContractAsPrimary::setEnvelopeID()
     ...
     * @param string $envelopeID
     * @return \StructType\GetContractAsPrimary
     */
