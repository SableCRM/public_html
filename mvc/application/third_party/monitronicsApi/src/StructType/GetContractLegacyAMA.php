...
/**
 * This class stands for GetContractLegacyAMA StructType
 * @subpackage Structs
 */
class GetContractLegacyAMA extends AbstractStructBase
{
    /**
     * The ContractID
    ...
    public $ContractID;
    /**
     * Constructor method for GetContractLegacyAMA
     * @uses GetContractLegacyAMA::setContractID()
     ...
     * @param int $contractID
     * @return \StructType\GetContractLegacyAMA
     */
