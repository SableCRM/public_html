...
/**
 * This class stands for SendQuoteEmail2 StructType
 * @subpackage Structs
 */
class SendQuoteEmail2 extends AbstractStructBase
{
    /**
     * The ContractData
    ...
    public $ContractData;
    /**
     * Constructor method for SendQuoteEmail2
     * @uses SendQuoteEmail2::setContractData()
     ...
     * @param \StructType\ContractDocument2 $contractData
     * @return \StructType\SendQuoteEmail2
     */
