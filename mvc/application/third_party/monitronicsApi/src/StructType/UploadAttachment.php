...
class UploadAttachment extends AbstractStructBase
{
     ...
     * @uses UploadAttachment::setTag()
     * @param string $attachment
     * @param string $tag
     */
    public function __construct($attachment = null, $tag = null)
    {
        $this
     ...
     * @param string $attachment
     * @return \StructType\UploadAttachment
     */
    public function setAttachment($attachment = null)
    {
        // validation for constraint: string
        if (!is_null($attachment) && !is_string($attachment)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a string, "%s" given', gettype($attachment)), __LINE__);
        }
