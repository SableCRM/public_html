...
/**
 * This class stands for GetContract StructType
 * @subpackage Structs
 */
class GetContract extends AbstractStructBase
{
    /**
     * The EnvelopeID
    ...
    public $EnvelopeID;
    /**
     * Constructor method for GetContract
     * @uses GetContract::setEnvelopeID()
