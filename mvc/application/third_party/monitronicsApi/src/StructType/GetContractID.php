...
/**
 * This class stands for GetContractID StructType
 * @subpackage Structs
 */
class GetContractID extends AbstractStructBase
{
    /**
     * The EnvelopeID
    ...
    public $EnvelopeID;
    /**
     * Constructor method for GetContractID
     * @uses GetContractID::setEnvelopeID()
     ...
     * @param string $envelopeID
     * @return \StructType\GetContractID
     */
