<div id="package_details" class="module">
    ...
    <div class="module-body">
        ...
        <div id="takeover" class="package_detail eighth">
            ...
            <input type="checkbox" <?php echo ($deal["Takeover"] == "true") ? "checked" : "" ?>>
        </div>

        <div id="video" class="package_detail eighth">
            <label>Video:</label>
            <input type="checkbox" <?php echo ($deal["ADC Video"] == "true") ? "checked" : "" ?>>
        </div>

        <div id="twoway" class="package_detail eighth">
            <label>Twoway:</label>
            <input type="checkbox" <?php echo ($deal["Two Way Voce"] == "true") ? "checked" : "" ?>>
        </div>
